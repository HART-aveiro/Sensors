...
int SensorVal1, SensorVal2, SensorVal3;
int processed_value1, processed_value2, processed_value3;
...
{ 
  uint16_t exponential_average=current_value;
...
{ 
 uint16_t exponential_average1=current_value;
...
{ 
 uint16_t exponential_average2=current_value;
...
int getFS1values(void){
  ...
  processed_value1 = ema_filter(SensorVal1);                            //filters the value using EMA                                                            
...
int getFS2values(void){                                                         //Equal behaviour as above
  ...
  processed_value2 = ema_filter1(SensorVal2);
...
int getFS3values(void){                                                         //Equal behaviour as above
  ...
  processed_value3 = ema_filter2(SensorVal3);
